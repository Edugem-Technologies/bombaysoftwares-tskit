 ...
 */
const getDateTime = (timestamp, showSeconds = true) => {
...
const formatTimestamp = (timestamp) => {
    ...
    let hoursIST = (0, exports.getTwodigitFormat)(ISTTime.getHours());
    let minutesIST = (0, exports.getTwodigitFormat)(ISTTime.getMinutes());
